...
fn main() {
  ...
  let px_delta_u: Vec3 = VWPT_U / IMG_W as Flt;
  let px_delta_v: Vec3 = VWPT_V / IMG_H as Flt;

  let vwpt_up_l: Vec3 =
    CAM_CTR - Vec3::new(0., 0., FOC_L) - VWPT_U / 2. - VWPT_V / 2.;
  let px_loc: Vec3 = vwpt_up_l + 0.5 * (px_delta_u + px_delta_v);
